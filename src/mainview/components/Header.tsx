        ...
        <header className="h-10 bg-neutral-900 border-b border-neutral-800 flex items-center px-4 flex-shrink-0">
            <div className="flex items-center justify-between w-full">
                <div className="flex items-center space-x-3 overflow-hidden">
                    <div className="flex items-center h-5 mr-1 animate-in fade-in slide-in-from-left-4 duration-500">
                        <img src="/logo-long.png" className="h-full object-contain filter drop-shadow-[0_0_8px_rgba(16,185,129,0.2)]" alt="Xyrvex" />
                    </div>
                ...
                <div className="flex items-center space-x-4">
                    <button
                        ...
                        className={`flex items-center space-x-2 px-3 py-1.5 rounded-lg transition-all border duration-300 group ${isAutoSave
